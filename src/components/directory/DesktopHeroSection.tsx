      ...
      <div className="container mx-auto text-center">
        ...
        <div className="relative max-w-xl mx-auto mb-6">
          ...
          <Input
            ...
            className="pl-10 h-12 w-full text-xl md:text-2xl rounded-lg bg-background/10 text-primary-foreground placeholder:text-primary-foreground/70 border border-primary-foreground/30 focus-visible:ring-offset-0"
            value={searchTerm}
