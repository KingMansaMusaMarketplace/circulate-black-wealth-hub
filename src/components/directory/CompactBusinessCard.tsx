  ...
  return (
    ...
    >
      ...
      <div className="relative w-20 h-20 flex-shrink-0 rounded-lg overflow-hidden">
        <OptimizedImage
          src={getBusinessCardImage(business.id, business.bannerUrl, business.website, business.category) || business.imageUrl || business.logoUrl || generatePlaceholder(80, 80, business.name)}
          alt={business.name}
