            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button 
                  ...
                  variant="outline" 
                  size="lg" 
                  className="group border-2 border-white/30 text-white hover:bg-white/10 hover:border-white/50 font-semibold text-lg px-8 py-6 rounded-xl backdrop-blur-sm transition-all duration-300"
                >
              ...
              <div className="mt-8">
                <Link 
                  to="/how-it-works"
                  className="inline-flex items-center gap-2 text-blue-200/70 hover:text-mansagold transition-colors font-medium"
                >
                  Learn How It Works
