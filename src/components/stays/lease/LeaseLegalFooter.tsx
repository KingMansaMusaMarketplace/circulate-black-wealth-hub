...
const LeaseLegalFooter: React.FC = () => (
  <div className="mt-12 border-t border-white/10 pt-6 text-xs text-white/80 space-y-2 max-w-4xl mx-auto">
    <p>
      <strong className="text-white">Mansa Stays is a listing platform, not a real estate broker.</strong>{" "}
    ...
    <p>
      <strong className="text-white">Fair Housing:</strong> Listings on Mansa Stays comply with the federal Fair
