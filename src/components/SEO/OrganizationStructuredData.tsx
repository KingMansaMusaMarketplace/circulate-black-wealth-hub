...
export const OrganizationStructuredData = () => {
  const structuredData = {
    ...
    description: 'The largest verified Black-owned business directory with 43,000+ listings. Discover and support Black-owned businesses, earn rewards, and circulate community wealth.',
