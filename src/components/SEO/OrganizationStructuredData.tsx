...
export const OrganizationStructuredData = () => {
  const structuredData = {
    ...
    description: 'The largest verified Black-owned global business directory with 46,000+ listings. Discover and support Black-owned businesses, earn rewards, and circulate community wealth.',
