...
const PitchSlide12Team: React.FC = () => {
  ...
  const aiWorkforce = [
    ...
    { 
      ...
      detail: '46 patent claims monitoring, competitive filing surveillance, claim amendments'
    },
    { 
      icon: BarChart3, 
      name: 'Kayla IR', 
        ...
        >
          <Card className="p-5 bg-black/60 border border-purple-500/30">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-purple-400/70 text-xs font-medium ml-1">Powered by Kayla — 42 Agentic AI Employees</span>
            </div>
