...
const HistoryPanel = () => {
  return (
    <div className="md:order-2">
      <div className="glass-card gradient-premium p-8 rounded-xl shadow-lg">
        <h3 className="text-mansagold text-xl font-bold mb-4">Mansa Musa: The Wealthiest Person in History</h3>
