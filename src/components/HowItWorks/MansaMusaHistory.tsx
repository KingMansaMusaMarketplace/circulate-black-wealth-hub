...
const MansaMusaHistory = () => {
  ...
  return (
    <section id="history" className="py-10 bg-slate-900/60 backdrop-blur-sm relative overflow-hidden">
      {/* Background pattern */}
      <div className="absolute top-0 left-0 w-full h-full opacity-10">
        <div className="absolute top-0 left-0 right-0 h-40 bg-gradient-to-b from-mansagold/20 to-transparent"></div>
      </div>
      ...
      <div className={`container-custom transition-opacity duration-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
        <div className="text-center mb-6">
          <h2 className="heading-lg text-white mb-2 relative">
            <span className="relative inline-block">
              ...
              <span className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-transparent via-mansagold to-transparent"></span>
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="md:order-2">
            <div className="bg-slate-800/60 backdrop-blur-xl p-6 rounded-xl border border-white/10 shadow-lg">
              <h3 className="text-mansagold text-xl font-bold mb-3">Mansa Musa: The Wealthiest Person in History</h3>
              <p className="text-blue-100/90 mb-3">
