  ...
  return (
    <section className="py-6 md:py-8 bg-gradient-to-b from-mansablue-dark/50 to-mansablue-dark">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-br from-red-500/10 via-orange-500/10 to-amber-500/10 border border-mansagold/20 rounded-2xl p-6 md:p-8 backdrop-blur-sm">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 mb-4">
              <span className="text-4xl md:text-5xl font-bold text-red-400">6 hours</span>
