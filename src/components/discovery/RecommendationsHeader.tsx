...
const RecommendationsHeader = React.forwardRef<HTMLDivElement>((_, ref) => {
  const navigate = useNavigate();
  
  return (
    <>
      <div ref={ref} className="flex justify-between items-center animate-slide-in-right">
...
export const RecommendationsFooter = React.forwardRef<HTMLDivElement>((_, ref) => {
  const navigate = useNavigate();
  
  return (
    <div ref={ref} className="flex justify-center mt-6 animate-fade-in">
...
RecommendationsFooter.displayName = 'RecommendationsFooter';
