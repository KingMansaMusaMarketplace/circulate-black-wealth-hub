  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const addPageNumberOnly = () => {
        ...
        pdf.text('1325.AI Blue Book - CONFIDENTIAL & PROPRIETARY - U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending', pageWidth / 2, pageHeight - 15, { align: 'center' });
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-white/90">
                  Complete technical documentation of all 46 patent claims
                </CardDescription>
