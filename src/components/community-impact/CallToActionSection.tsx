      ...
      <Card className="bg-gradient-to-br from-mansablue via-mansablue to-mansablue-dark text-white shadow-2xl border-0 overflow-hidden relative">
        ...
        <CardContent className="p-6 md:p-8 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-blue-100 mb-6 leading-relaxed max-w-xl mx-auto">
              {user 
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center items-center mb-4">
              {user ? (
                <>
                  <Link to="/directory">
                    <Button size="lg" className="bg-mansagold hover:bg-mansagold-dark text-mansablue font-semibold px-6 py-3 shadow-lg hover:shadow-xl transition-all duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-white/20">
              <div className="text-center">
                <div className="text-xl font-bold text-mansagold mb-1">2,450+</div>
                <div className="text-sm text-blue-100">Community Members</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-mansagold mb-1">187+</div>
                <div className="text-sm text-blue-100">Black-Owned Businesses</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-bold text-mansagold mb-1">$485K+</div>
