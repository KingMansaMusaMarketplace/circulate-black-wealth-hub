...
const pillars = [
  {
    ...
    body: 'Every contribution goes into a digital escrow account — not a "banker\'s" wallet or personal bank account. Funds only release when the circle\'s rules are met. Protected under U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending.'
  },
  {
    icon: UserCheck,
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1 leading-relaxed">
                Our Susu escrow technology is protected under U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending.
