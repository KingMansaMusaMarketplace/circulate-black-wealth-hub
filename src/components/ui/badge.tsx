...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold font-body transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 hover:scale-105 active:scale-95",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground border-border hover:bg-accent/50 hover:border-primary/30",
      },
    },
    defaultVariants: {
      variant: "default",
