...
const TeamSection = () => {
  ...
  return (
    <section className="py-20 bg-transparent relative overflow-hidden">
      ...
      <div className="absolute top-20 right-20 w-72 h-72 bg-gradient-to-br from-mansablue/20 to-blue-500/20 rounded-full blur-3xl animate-pulse"></div>
      <div className="absolute bottom-20 left-20 w-96 h-96 bg-gradient-to-br from-mansagold/20 to-amber-500/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
