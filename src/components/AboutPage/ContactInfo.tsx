...
const ContactInfo = () => {
  ...
  return (
    <Card className="h-full border-2 border-violet-200 bg-gradient-to-br from-white via-violet-50 to-fuchsia-50 backdrop-blur-sm shadow-xl">
      <CardContent className="p-6 sm:p-8">
        <h3 className="text-xl font-bold bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent mb-6">Get In Touch</h3>
                ...
                <motion.div 
                  className={`flex items-center p-3 sm:p-4 rounded-lg cursor-pointer transition-all border-2 ${
                    activeContact === item.id 
                      ...
                      : 'hover:bg-gradient-to-r hover:from-violet-50 hover:to-fuchsia-50 border-violet-200'
                  }`}
