  ...
  return (
    <div className="prose prose-sm max-w-none dark:prose-invert">
      ...
      <ul className="list-none ml-4">
        ...
        Fraud Detection systems, API Gateway architecture, and all 46 patent claims documented in USPTO 
      ...
      <div className="mt-8 text-center text-xs text-muted-foreground border-t pt-4">
        ...
        <p>U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending</p>
