...
const SponsorshipSuccessStories = () => {
  const stories = [
    ...
    },
    {
      ...
      description: "Our Gold tier sponsorship funded a technology access program that provided digital resources to 150 businesses, helping them increase their online visibility and sales by an average of 28%.",
