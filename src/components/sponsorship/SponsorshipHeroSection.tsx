      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="text-[11px] md:text-xs text-white tracking-[0.2em] uppercase"
          >
            U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending · Verified Corporation · HBCU Partner Network
          </motion.div>
        </div>
      </div>
    </section>
