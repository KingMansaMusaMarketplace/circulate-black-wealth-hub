  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; padding: 30px; color: #000000; line-height: 1.6;">
      ...
      <div style="margin-bottom: 25px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
          ...
          <div style="font-size: 14px;">
            ...
            <p style="margin: 0; color: #000000; line-height: 1.6;">Direct support for business growth and community wealth building.</p>
          </div>
        </div>
      </div>
      ...
      <div style="text-align: center; padding: 18px; background-color: #1a1a1a; color: white; border-radius: 6px;">
        ...
        <div style="font-size: 14px;">
          <p style="margin: 5px 0;"><strong>Email:</strong> Partner@1325.AI</p>
      ...
      <div style="text-align: center; margin-top: 20px; font-size: 13px; color: #000000;">
        <p>© 2026 1325.AI • U.S. Provisional Patent Application No. 63/969,202 — 45 claims pending • www.1325.ai</p>
      </div>
    </div>
  `;
};
