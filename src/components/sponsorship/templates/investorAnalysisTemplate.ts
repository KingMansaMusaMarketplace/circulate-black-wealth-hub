  ...
  return `
    <div style="font-family: 'Georgia', serif; max-width: 800px; margin: 0 auto; padding: 40px; color: #000000;">
      ...
      <div style="background: #000000; color: white; padding: 30px; border-radius: 8px; text-align: center;">
        ...
        <p style="font-size: 14px; margin-bottom: 5px; color: #ffffff;"><strong>Email:</strong> Partner@1325.AI</p>
        <p style="font-size: 14px; margin-bottom: 0; color: #ffffff;"><strong>Phone:</strong> 312.900.6004</p>
      </div>
