  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 800px; margin: 0 auto; padding: 40px; color: #000000;">
      ...
      <div style="margin-bottom: 30px;">
        <h3 style="color: #000000; font-size: 20px; margin-bottom: 15px; font-weight: bold;">Key Impact Metrics</h3>
      ...
      <div style="text-align: center; margin-top: 40px; padding: 20px; background-color: #1a1a1a; color: white; border-radius: 8px;">
        ...
        <p style="margin-bottom: 15px; font-size: 16px;">U.S. Provisional Patent Application No. 63/969,202 — 45 claims pending • Economic Circulation Technology</p>
