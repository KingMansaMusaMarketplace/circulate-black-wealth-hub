      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          <Badge className="bg-gradient-to-r from-yellow-400 via-amber-500 to-yellow-400 text-slate-900 px-6 py-3 text-lg font-bold rounded-full mb-6 inline-flex items-center shadow-lg">
            ...
            PHASE 1: FREE GROWTH - Everything FREE Until March 2026!
          </Badge>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 text-center md:text-left">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-blue-200 text-sm">Join before March 2026 and get this exclusive badge forever</p>
                </div>
              </div>
          ...
          <Link to="/signup?type=business" className="block group">
            <Card className="bg-slate-900/40 backdrop-blur-xl border border-white/10 hover:border-yellow-400/50 transition-all cursor-pointer h-full group-hover:scale-105 group-hover:shadow-[0_0_30px_rgba(251,191,36,0.2)]">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-xl font-semibold text-yellow-300 mb-2">FREE until March 2026</p>
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl rounded-2xl p-8 mb-12 border border-blue-400/30">
          <div className="text-center mb-6">
            <Badge className="bg-blue-500 text-white mb-4">Coming March 2026</Badge>
