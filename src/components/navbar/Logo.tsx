...
const Logo: React.FC = () => {
  return (
    <Link to="/" className="flex items-center space-x-3 group">
      <div className="w-20 h-20 rounded-full overflow-hidden border-3 border-mansagold/30 shadow-lg bg-white/10 backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 group-hover:shadow-xl">
        <img 
          src={mansaMusaLogo} 
