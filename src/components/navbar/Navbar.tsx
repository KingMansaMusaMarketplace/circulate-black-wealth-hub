      ...
      >
        <div className="w-full px-2 sm:px-6 lg:px-8 max-w-7xl mx-auto overflow-visible">
          <div className="flex h-16 items-center justify-between w-full gap-1 sm:gap-3 overflow-visible">
            ...
            <motion.div 
              className="flex items-center gap-1 sm:gap-2 md:gap-3 flex-shrink-0 overflow-visible"
              initial={{ x: 20, opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
            ...
            >
              ...
              {isAdmin && (
                <Button
                  ...
                  className="relative hover:bg-white/10 text-white hover:text-mansagold transition-all duration-300 hover:scale-105 rounded-lg h-9 w-9 min-w-[36px] flex-shrink-0"
