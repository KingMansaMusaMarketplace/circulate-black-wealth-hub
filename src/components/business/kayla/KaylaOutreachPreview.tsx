      ...
      <CardContent className="space-y-3">
        <div className="p-4 rounded-lg bg-slate-900/60 border border-white/5 space-y-3">
          ...
          <div className="border-t border-white/10 pt-3 space-y-2">
            ...
            <p className="text-xs text-white/80 font-medium mt-3">STARTING TODAY, KAYLA CAN HANDLE:</p>
            <ul className="space-y-1.5 ml-4">
              <li className="text-sm text-white/90 flex items-start gap-2">
                <Sparkles className="h-3 w-3 text-yellow-400 mt-1 shrink-0" />
                <span><strong className="text-white">24/7 Review Management</strong> — drafts professional, on-brand responses to every customer review in seconds</span>
              </li>
              <li className="text-sm text-white/90 flex items-start gap-2">
                <Sparkles className="h-3 w-3 text-yellow-400 mt-1 shrink-0" />
              ...
              <li className="text-sm text-white/90 flex items-start gap-2">
                <Sparkles className="h-3 w-3 text-yellow-400 mt-1 shrink-0" />
                <span><strong className="text-white">Churn Prediction</strong> — identifies at-risk customers before they leave, protecting your revenue</span>
              </li>
              <li className="text-sm text-white/90 flex items-start gap-2">
                <Sparkles className="h-3 w-3 text-yellow-400 mt-1 shrink-0" />
                <span><strong className="text-white">Content Generation</strong> — creates social posts and promotions to keep your brand active on autopilot</span>
              </li>
            </ul>
            ...
            <p className="text-sm text-white/80 pt-2 italic">
