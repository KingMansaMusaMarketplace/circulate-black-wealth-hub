...
export const siteConfig = {
  ...
  investorDescription: '1325.AI is the agentic commerce protocol — the infrastructure layer where autonomous AI organizations discover, transact, and circulate wealth across an underserved $2.10T U.S. Black consumer market (2025) and a $9.1T global Black consumer market. While 99% of AI companies build assistants, we built the rails AI agents transact on. We own the transaction ledger, the supply chain graph, and the orchestration layer that powers Level 3 AI organizations for every business on the network.',
