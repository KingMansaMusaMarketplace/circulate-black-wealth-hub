    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-mansablue-dark to-slate-900">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        <Card className="glass-card border-white/10 mb-12">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="text-white/90 text-sm">
                API usage includes a license to use our patented technology (U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending) within your
        ...
        <div className="mt-12 text-center text-white/40 text-sm">
          All APIs protected under U.S. Provisional Patent Application No. 63/969,202 — 46 claims pending
