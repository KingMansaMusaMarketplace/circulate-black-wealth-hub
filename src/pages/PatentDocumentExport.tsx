      ...
      <Card className="mb-6 border-mansagold/30 bg-gradient-to-r from-mansagold/5 to-transparent">
        ...
        <CardContent>
          <p className="text-muted-foreground mb-4">
            ...
            all 46 patent claims, database schemas, RLS policies, and system implementations.
          </p>
...
Full source code implementation in codebase.`}
        ...
        <div id="patent-content" className="bg-white text-black p-8" style={{ fontFamily: 'Times New Roman, serif', fontSize: '12pt', lineHeight: '1.6' }}>
          ...
          <p style={{ textAlign: 'justify', marginBottom: '15px' }}>
            The invention implements a database-level trigger mechanism that automatically and irrevocably assigns "founding member" status to users who register before a predetermined temporal cutoff (September 1, 2026, 23:59:59 UTC).
          </p>
          <p style={{ textAlign: 'justify', marginBottom: '15px' }}>
