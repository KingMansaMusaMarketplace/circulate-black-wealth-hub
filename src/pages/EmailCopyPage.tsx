...
[Your Name]`,
  },
  {
    ...
    subject: 'The Infrastructure Layer for $2.10T U.S. / $9.1T Global in Community Capital — Partnership Inquiry',
...
We are the agentic commerce protocol for community wealth — the infrastructure layer where AI agents discover, transact, and circulate dollars across an underserved $2.10T U.S. and $9.1T global market. While most AI companies build assistants, we built the rails AI organizations transact on, with 46 patent claims protecting our orchestration layer, transaction ledger, and supply chain graph.
...
- Patent-protected infrastructure — 46 claims covering geospatial fraud detection, B2B matching, and orchestration. Defensible moat, not a dashboard.
...
I'm the founder of 1325.AI, the agentic commerce protocol powering a $2.10T U.S. and $9.1T global underserved market. While 99% of AI companies build assistants, we built the rails autonomous AI organizations transact on: a transaction ledger, a supply chain graph, and an orchestration layer protected by 46 patent claims.
