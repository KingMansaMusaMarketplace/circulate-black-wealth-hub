  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-gradient-to-bl from-mansagold/25 to-amber-600/25 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
