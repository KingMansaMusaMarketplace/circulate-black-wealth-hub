      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 via-blue-100 to-teal-100 dark:from-gray-900 dark:via-purple-950 dark:to-blue-950">
        ...
        <section className="py-12 px-4">
          <div className="container-custom mx-auto">
            ...
            {/* Call to Action */}
            <Card className="relative overflow-hidden bg-gradient-to-r from-pink-950 via-purple-950 via-blue-950 to-teal-950 border-none shadow-2xl">
              ...
              {/* Decorative Orbs */}
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-gradient-to-br from-pink-600 to-yellow-600 opacity-10 rounded-full blur-3xl animate-pulse" />
              <div className="absolute -bottom-20 -left-20 w-64 h-64 bg-gradient-to-br from-blue-600 to-purple-600 opacity-10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
              <div className="absolute top-1/2 right-1/4 w-48 h-48 bg-gradient-to-br from-emerald-600 to-teal-600 opacity-5 rounded-full blur-2xl animate-pulse" style={{ animationDelay: '0.5s' }} />
