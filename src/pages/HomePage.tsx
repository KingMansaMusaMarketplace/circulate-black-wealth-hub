    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden" style={{ contain: 'layout' }}>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none" aria-hidden="true">
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-gradient-to-br from-mansablue/20 to-blue-600/20 rounded-full blur-3xl animate-float will-change-transform" />
          <div className="absolute top-1/4 -right-32 w-[32rem] h-[32rem] bg-gradient-to-tl from-mansagold/15 to-amber-500/15 rounded-full blur-3xl animate-pulse will-change-transform" style={{ animationDelay: '1s', animationDuration: '4s' }} />
        </div>
