...
export default function BlackOwnedIndexPage() {
  ...
  const collectionSchema = {
    ...
    mainEntity: {
      "@type": "ItemList",
      numberOfItems: totalCount || 47000,
  ...
  return (
    <>
      <Helmet>
        <title>Black-Owned Global Business Directory | 47,000+ Verified Listings | 1325.AI</title>
        <meta name="description" content="The largest verified Black-owned global business directory. Find 47,000+ Black-owned restaurants, salons, barbershops, contractors & services near you. Free on 1325.AI." />
        ...
        <meta property="og:title" content="Black-Owned Global Business Directory | 47,000+ Verified Listings" />
        <meta property="og:description" content="Find 47,000+ verified Black-owned businesses by city and category on 1325.AI." />
      ...
      <main className="dark container mx-auto px-4 py-12 bg-background text-foreground min-h-screen">
        <header className="mb-10 text-center max-w-3xl mx-auto">
          ...
          <p className="text-muted-foreground text-lg mb-2">
            Find <strong>{(totalCount || 47000).toLocaleString()}+</strong> verified Black-owned businesses near you — restaurants, salons, barbershops, contractors and services across the United States.
          </p>
