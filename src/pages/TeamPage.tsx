...
const leadership: Member[] = [
  ...
  { name: 'Lisa Gavin', title: 'President', photo: lisa, photoScale: 1.15, photoOffsetY: '0%' },
  ...
  { name: 'Zay Barton', title: 'Executive Advisor', photo: zay, objectPosition: 'center 75%', photoScale: 1.15 },
  ...
  { name: 'Kayla Bruton', title: 'Senior Contracts Manager', photo: kayla, objectPosition: 'center top', photoScale: 0.95, photoOffsetY: '4%', fixedPhotoBackground: true },
