...
const EatOkraPartnershipPage: React.FC = () => {
  ...
  const handleScheduleCall = () => {
    ...
    window.open('mailto:Partner@1325.AI?subject=EatOkra%20Partnership%20Inquiry', '_blank');
  };
              ...
              <CardContent className="p-8 md:p-12 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      window.open('mailto:Partner@1325.AI?subject=EatOkra%20Partnership%20PDF%20Request', '_blank');
                    }}
                  >
