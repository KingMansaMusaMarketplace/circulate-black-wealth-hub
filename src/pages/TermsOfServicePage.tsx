...
const TermsOfServicePage = () => {
  const sections = [
    ...
    },
    {
      ...
      gradient: "from-indigo-50 via-purple-50 to-indigo-50",
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-primary to-purple-600 text-white">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-6">
            {sections.map((section, index) => (
              <Card 
                key={index} 
                className={`hover:shadow-xl transition-all border-2 bg-gradient-to-br ${section.gradient} ${section.borderColor}`}
              >
                <CardHeader>
                  <CardTitle className={`flex items-center gap-3 ${section.textColor} font-bold`}>
          ...
          {/* Footer Notice */}
          <Card className="mt-12 border-2 bg-gradient-to-br from-yellow-50 via-amber-50 to-yellow-50 border-yellow-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-yellow-700 mb-2 text-lg">Important Notice ⚠️</h3>
                  <p className="text-foreground/80 leading-relaxed">
