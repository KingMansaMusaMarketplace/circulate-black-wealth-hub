...
const FullSystemTestPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] via-[#050a18] to-[#030712] flex flex-col relative overflow-hidden">
      ...
      <Helmet>
        <title>Full System Test | 1325.AI</title>
