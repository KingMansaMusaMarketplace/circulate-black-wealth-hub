...
const SLIDES = [
  ...
  { id: 4, title: '46 Patent Claims', component: PitchSlide4Technology },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-mansablue-dark via-[hsl(210,100%,12%)] to-[hsl(210,100%,8%)] flex flex-col">
      <Helmet>
        ...
        <meta name="description" content="1325.AI investor pitch deck — the economic operating system for the Black economy. 46 patent claims, 8 revenue streams, $2.10T U.S. and $9.1T global market."  />
      </Helmet>
