  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] via-[#050a18] to-[#030712] relative flex flex-col justify-center py-12">
      <Helmet>
        ...
        <meta name="description" content="Add your Black-owned business to 1325.AI in 2 minutes. Get found by 47,000+ supporters and unlock Kayla, your free AI employee (~4 roles covered)." />
        <meta property="og:title" content="List Your Black-Owned Business Free | 1325.AI" />
        <meta property="og:description" content="Get found by 47,000+ supporters and unlock free AI-powered customer tools." />
