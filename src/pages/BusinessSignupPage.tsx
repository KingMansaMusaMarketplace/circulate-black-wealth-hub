  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#000000] via-[#050a18] to-[#030712] relative flex flex-col justify-center py-12">
      <Helmet>
        ...
        <meta name="description" content="Add your Black-owned business to 1325.AI in 2 minutes. Get found by 46,000+ supporters and unlock Kayla, your free AI employee (~4 roles covered)." />
        <meta property="og:title" content="List Your Black-Owned Business Free | 1325.AI" />
        <meta property="og:description" content="Get found by 46,000+ supporters and unlock free AI-powered customer tools." />
            ...
            <div className="relative border-2 border-mansagold/40 bg-gradient-to-br from-slate-900/95 via-slate-800/90 to-purple-900/50 backdrop-blur-xl rounded-3xl p-8 md:p-12 shadow-2xl overflow-hidden">
              ...
              <div className="relative text-center">
                ...
                <div className="flex flex-wrap items-center justify-center gap-4 md:gap-8">
                  ...
                  <div className="hidden md:block w-px h-12 bg-white/20" />
                  <div className="text-center">
                    <p className="text-3xl md:text-4xl font-extrabold text-purple-400">~4</p>
