...
export const createTables = async (): Promise<InitDbResult> => {
  try {
    ...
    await setupTable('redeemed_rewards', `
    ...
    await setupTable('qr_code_functions', `
