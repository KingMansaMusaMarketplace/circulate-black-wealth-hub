...
export const AGREEMENT_SECTIONS: AgreementSection[] = [
  ...
  },
  {
    ...
    body: 'All platform technology, software, data models, and related intellectual property remain the exclusive property of 1325.AI, including subject matter disclosed in U.S. Provisional Patent Application No. 63/969,202 \u2014 46 claims pending. Nothing in this Agreement conveys any license to that intellectual property beyond the limited brand license in Section 5.',
  },
  {
