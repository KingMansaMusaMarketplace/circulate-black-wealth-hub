...
export const SHOPIFY_STORE_PERMANENT_DOMAIN = 'circulate-black-wealth-hub-fdusv.myshopify.com';
export const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
export const SHOPIFY_STOREFRONT_TOKEN = 'cd19e706f2bc6a6771d8503c26b84b4f';
