...
export const pageSEO = {
  home: {
    title: 'Black-Owned Global Business Directory | 46,000+ | 1325.AI',
    description: 'The largest verified Black-owned global business directory. Find 46,000+ Black-owned restaurants, shops & services near you. Powered by 1325.AI.',
  ...
  directory: {
    ...
    description: 'Find verified Black-owned businesses near you — restaurants, shops, services & pros. Search 46,000+ listings free on 1325.AI.',
  ...
  about: {
    ...
    description: 'Meet 1325.AI — the AI-powered platform helping you find, support and circulate dollars to 46,000+ Black-owned businesses nationwide.',
  ...
  businessSignup: {
    ...
    description: 'Add your Black-owned business to 1325.AI in 2 minutes. Get found by 46,000+ supporters and unlock free AI-powered customer tools.',
