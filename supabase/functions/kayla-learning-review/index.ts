...
serve(async (req) => {
  ...
  try {
    ...
    // ---- Authorization: scheduled-job secret, or an admin JWT ----
    // This job makes paid AI calls and writes verdicts onto agent learnings,
    // so it must never be runnable by an anonymous caller.
