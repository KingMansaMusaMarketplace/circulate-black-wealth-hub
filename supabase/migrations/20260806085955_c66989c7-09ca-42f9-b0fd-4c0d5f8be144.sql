...
BEGIN
  ...
  IF NEW.is_verified IS DISTINCT FROM OLD.is_verified
     ...
     OR NEW.ownership_flagged IS DISTINCT FROM OLD.ownership_flagged THEN
...
REVOKE ALL ON FUNCTION public.protect_businesses_privileged_cols_v2() FROM PUBLIC, anon, authenticated;