...
SELECT 
    ...
    CASE 
        WHEN document_url IS NOT NULL THEN 'Document Available'
        ELSE 'No Document'
...
-- 5. Create storage policies for the hbcu-verification bucket (if not already exists)
-- Note: Storage policies might already exist, but we'll ensure they're secure
