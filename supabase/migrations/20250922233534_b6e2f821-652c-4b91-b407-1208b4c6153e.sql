...
-- Add comment to the view explaining its purpose
COMMENT ON VIEW public.sales_agent_applications_summary IS 'Non-sensitive summary of sales agent applications. Inherits RLS policies from underlying table.';