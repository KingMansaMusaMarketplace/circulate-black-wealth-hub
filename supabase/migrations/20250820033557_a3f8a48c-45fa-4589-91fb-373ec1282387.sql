...
-- 6. Create trigger for role change auditing
...
-- 7. Add admin role assignment function (for initial admin setup)
...
AS $$
BEGIN
  -- Only allow this function to be called by existing admins or if no admins exist
